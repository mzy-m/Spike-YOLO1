...
class RepLKNet(nn.Module):
    ...
    def __init__(self, large_kernel_sizes, layers, channels, drop_path_rate, small_kernel,
                 dw_ratio=1, ffn_ratio=4, in_channels=3, num_classes=1000, out_indices=[1,2,3],
...
def create_RepLKNet31L(drop_path_rate=0.3, num_classes=1000, use_checkpoint=False, small_kernel_merged=False):
...
if __name__ == '__main__':
    model = create_RepLKNet31B(small_kernel_merged=False,num_classes=None)
    model.eval()
